...
import { View, Text, ImageBackground,Image, ScrollView, TouchableOpacity, Modal, FlatList} from 'react-native';
            ...
            <View style={styles.infoArea}>
                ...
                <View style={styles.notesArea}>
                    ...
                    <View style={styles.bottomLike}>
                            ...
                            <Text style={styles.likesQtd}>{((detailSerie?.popularity) > 1000 ? Math.floor(detailSerie?.popularity / 1000) + 'K' : parseFloat(detailSerie?.popularity).toFixed(0))}</Text>
                        </View>
                    </View>
                </View>
            </View>
